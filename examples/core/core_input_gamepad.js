...
;(function() {
    // Initialization
    //--------------------------------------------------------------------------------------
    // NOTE: This part was edited for supporting both modern and legacy gamepads...
    //var XBOX360_NAME_ID = "Xbox 360 Controller";
    //var XBOX_NAME_ID = "Xbox Controller";
    var PS3_NAME_ID = "PLAYSTATION(R)3 Controller";
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            {
                DrawText("GP1: " + GetGamepadName(GAMEPAD_PLAYER1), 10, 10, 10, BLACK);
                if (GetGamepadName(GAMEPAD_PLAYER1).indexOf("Xbox") > -1)
                {
                ...
                else if (IsGamepadName(GAMEPAD_PLAYER1, PS3_NAME_ID))
                {
                    ...
                    if (IsGamepadButtonDown(GAMEPAD_PLAYER1, GAMEPAD_BUTTON_MIDDLE_RIGHT)) DrawTriangle(new Vector2(436, 168), new Vector2(436, 185), new Vector2(464, 177), RED);
                    ...
                    DrawRectangle(169, 48, 15, (((1.0 - GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_AXIS_LEFT_TRIGGER))/2.0)*70), RED);
                    DrawRectangle(611, 48, 15, (((1.0 - GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_AXIS_RIGHT_TRIGGER))/2.0)*70), RED);
                }
                else
                {
                ...
                DrawText("DETECTED AXIS [" + GetGamepadAxisCount(GAMEPAD_PLAYER1) + "]:", 10, 50, 10, MAROON);

                for (var i = 0; i < GetGamepadAxisCount(GAMEPAD_PLAYER1); i++)
                {
                    DrawText("AXIS " + i + ": " + GetGamepadAxisMovement(GAMEPAD_PLAYER1, i), 20, 70 + 20*i, 10, DARKGRAY);
                }

                if (GetGamepadButtonPressed() != -1) DrawText("DETECTED BUTTON: " + GetGamepadButtonPressed(), 10, 430, 10, RED);
